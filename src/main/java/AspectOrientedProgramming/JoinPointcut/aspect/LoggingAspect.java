package AspectOrientedProgramming.JoinPointcut.aspect;

import AspectOrientedProgramming.JoinPointcut.Book;
...
public class LoggingAspect {
    @Before("AspectOrientedProgramming.JoinPointcut.aspect.MyPointcuts.allAddMethods()")
